...
import {
  ...
  MovePCParams,
  StakeParams,
  TestSignature as MessageSignature,
  Wallet,
  WrapCParams,
  UnwrapCParams,
  ERC20Params,
...
export function getImportCTxParams(network: string, publicKey: string): ImportCTxParams {
  return { network, publicKey, type: "IMPORT_CTX", importFee: new BN(0) };
}

export function getImportPTxParams(network: string, publicKey: string): ImportPTxParams {
